...
psql --quiet -v ON_ERROR_STOP="on" -c "INSERT into pirogue_test.vw_cat_animal (cid, fk_breed, eye_color, name, year) VALUES (12345, '1', 'yellow', 'ninja', 1934);"
...
psql --quiet -v ON_ERROR_STOP="on" -c "UPDATE pirogue_test.vw_cat_animal SET eye_color = 'black', year = 2000 WHERE cid = 12345;"
